package com.grupo4.proyecto.views.empleadosformacion;
...
@PageTitle("Empleados Formacion")
@Route(value = "data-grid", layout = MainLayout.class)
public class EmpleadosFormacionView extends Div {
    ...
    public EmpleadosFormacionView() {
        addClassName("empleados-formacion-view");
        setSizeFull();
        createGrid();
        add(grid);
    }
